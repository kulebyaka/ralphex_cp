...
Rate limit errors likely surface as text in assistant.message content, not as a separate error event type (UNVERIFIED — no rate limit was triggered during discovery).
